...
def SetupInputModules():
    ...
    for encoder in data["Encoders"]:
        if (encoder["Type"] == ""):
            ...
            encoderModules.append(InputHandlers.EncoderModule(encoder["Type"], buttonSettings, encoder["VirtualEncoderInfo"], virtualEncoderSettings))
...
if __name__ == "__main__":
    ...
    # send OSC messages
    Settings.OSCCLIENT = udp_client.SimpleUDPClient(ip, sendPort)
